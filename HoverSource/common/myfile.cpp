...
HRESULT CD3DFileObject::GetMaterial( D3DMATERIAL7* pMtrl )
{
    *pMtrl = m_Material[0].m_mtrl;
...
HRESULT CD3DFileObject::GetTextureName( CHAR** pTextureName )
{
    *pTextureName = m_Material[0].m_strTexture;
...
//-----------------------------------------------------------------------------
HRESULT CD3DFile::GetMeshMaterial( TCHAR* strName, D3DMATERIAL7* pMtrl ){

    CD3DFileObject* pObject = FindObject( strName );
    if( pObject )
        return pObject->GetMaterial( pMtrl );
...
HRESULT CD3DFile::GetMeshTextureName( TCHAR* strName, CHAR** pTextureName ){

    CD3DFileObject* pObject = FindObject( strName );
    if( pObject )
        return pObject->GetTextureName( pTextureName );
