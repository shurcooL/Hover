...
public:
    ...
    HRESULT         GetMeshGeometry( D3DVERTEX** ppVertices,
                                     ...
                                     DWORD* pdwNumIndices );
	HRESULT			GetMaterial( D3DMATERIAL7* pMtrl );
	HRESULT			GetTextureName( CHAR** pTextureName );
...
public:
    ...
    HRESULT		GetMeshMaterial( TCHAR* strName, D3DMATERIAL7* pMtrl );
	HRESULT		GetMeshTextureName( TCHAR* strName, CHAR** pTextureName );	
