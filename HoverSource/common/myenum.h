...
#include "d3dutilheaders/d3denum.h"
...
//-----------------------------------------------------------------------------
HRESULT MyEnum_SelectDefaultDevice( D3DEnum_DeviceInfo** pDevice,
                                     DWORD dwFlags );
...
//-----------------------------------------------------------------------------
HRESULT MyEnum_UserChangeDevice( D3DEnum_DeviceInfo** ppDevice );
