...
//-----------------------------------------------------------------------------
HRESULT CMyFramework7::DestroyObjects()
{
...
//-----------------------------------------------------------------------------
HRESULT CMyFramework7::Initialize( HWND hWnd, GUID* pDriverGUID,
...
// Desc: Creates the internal objects for the framework
//-----------------------------------------------------------------------------
HRESULT CMyFramework7::CreateEnvironment( GUID* pDriverGUID, GUID* pDeviceGUID,
...
//-----------------------------------------------------------------------------
HRESULT CMyFramework7::CreateDirectDraw( GUID* pDriverGUID, DWORD dwFlags )
{
...
//-----------------------------------------------------------------------------
HRESULT CMyFramework7::CreateFullscreenBuffers( DDSURFACEDESC2* pddsd )
{
    HRESULT hr;
...
//       Windowed mode and fullscreen mode are handled differently.
//-----------------------------------------------------------------------------
HRESULT CMyFramework7::CreateWindowedBuffers()
{
    HRESULT hr;
...
// Name: CreateZBuffer()
//-----------------------------------------------------------------------------
HRESULT CMyFramework7::CreateZBuffer( GUID* pDeviceGUID )
{
    HRESULT hr;
...
//-----------------------------------------------------------------------------
HRESULT CMyFramework7::CreateDirect3D( GUID* pDeviceGUID )
{
...
//-----------------------------------------------------------------------------
HRESULT CMyFramework7::RestoreSurfaces()
{
...
//-----------------------------------------------------------------------------
VOID CMyFramework7::Move( INT x, INT y )
{
...
//-----------------------------------------------------------------------------
HRESULT CMyFramework7::FlipToGDISurface( BOOL bDrawFrame )
{
...
//-----------------------------------------------------------------------------
HRESULT CMyFramework7::ShowFrame( BOOL bVSync )
{
    ...
    if( m_bIsFullscreen )
    {
        ...
        if( m_bIsStereo )
            return m_pddsFrontBuffer->Flip( NULL, DDFLIP_WAIT | DDFLIP_STEREO );
					...
					return m_pddsFrontBuffer->Flip( NULL, DDFLIP_WAIT | ( bVSync ? 0 : DDFLIP_NOVSYNC ) );
    }
    else
    {
